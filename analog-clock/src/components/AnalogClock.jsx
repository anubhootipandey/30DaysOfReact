  ...
  return (
    <div className='clock-container'>
        <div className="clock-hands">
            <div className="hour-hand hand" style={{transform: `rotate(${hourHand}deg)`}}></div>
            <div className="minute-hand hand" style={{transform: `rotate(${minuteHand}deg)`}}></div>
            <div className="second-hand hand" style={{transform: `rotate(${secondHand}deg)`}}></div>
        </div>
    </div>
  )
}
